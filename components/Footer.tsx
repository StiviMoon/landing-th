          ...
          <div className="lg:col-span-2">
            <div className="mb-4 md:mb-6">
              ...
              <p className="text-light/90 text-sm md:text-lg leading-relaxed mb-4 md:mb-6">
                Soluciones innovadoras y resultados reales en ingeniería civil,
                ambiental y agroindustrial. Transformamos ideas en soluciones
                sostenibles con estándares internacionales de calidad.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 md:gap-4">
              {socialLinks.map((social, index) => (
                <Link
                  ...
                  href={social.href}
                  target={
                    social.name !== "Teléfono" && social.name !== "Email"
                      ? "_blank"
                      : undefined
                  }
                  rel={
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <a
                    href="tel:3028404105"
                    className="block text-light hover:text-gold transition-colors text-xs md:text-sm"
                  >
                    302 840 4105
                  </a>
                  <a
              ...
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <div>
                  ...
                  <a
                    href="mailto:torhanningenieriasas@gmail.com"
                    className="text-light hover:text-gold transition-colors text-xs md:text-sm"
                  >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <p className="text-light/80 text-xs md:text-sm">
                © {new Date().getFullYear()} Torhann Ingeniería S.A.S. Todos los
                derechos reservados.
              </p>
            </div>
