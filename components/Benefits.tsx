...
export default function Benefits() {
  ...
  return (
    <section
      id="beneficios"
      className="py-16 md:py-20 bg-primary text-light"
      aria-label="Beneficios de trabajar con Torhann Ingeniería en Colombia"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-light/90 max-w-2xl mx-auto leading-relaxed px-2">
            Resultados garantizados con soporte 24/7 y compromiso con la
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <p className="text-sm md:text-lg text-light/90 leading-relaxed">
                {benefit}
              </p>
            </div>
          ))}
